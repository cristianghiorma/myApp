...
import { RestaurantOrderDeleteDialogComponent } from 'app/entities/restaurant-order/restaurant-order-delete-dialog.component';
  ...
  describe('RestaurantOrder Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [RestaurantOrderDeleteDialogComponent],
      })
